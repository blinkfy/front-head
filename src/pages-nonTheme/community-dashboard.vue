...
import './community-dashboard/community-dashboard.css'
import legacyMarkup from './community-dashboard/community-dashboard-markup.html?raw'
...
onMounted(async () => {
  ...
  await import('./community-dashboard/init-community-dashboard.js')
})
