<template>
  <view class="replay-screen">
    <view class="header panel">
      ...
      <AdminScreenHeader class="twin-screen-header" screen-key="digitalTwinReplay" tone="dark" @back="goBack">
...
const robotTaskRequest = computed(() => robotTaskFocusEvent.value?.payload?.request || {})
