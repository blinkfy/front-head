...
import './admin-ai-settings/admin-ai-settings.css'
import legacyMarkup from './admin-ai-settings/admin-ai-settings-markup.html?raw'
...
onMounted(async () => {
  ...
  await import('./admin-ai-settings/init-admin-ai-settings.js')
})
