<template>
  ...
  >
    ...
    <view class="center-meta">
      ...
      <view><text>处理泊位</text><b>{{ assignedBayId || '待分配' }}</b></view>
...
.center-meta { display:grid; grid-template-columns:repeat(5,minmax(0,1fr)); gap:6px; margin:10px 0; }.center-meta view { min-width:0; padding:7px 8px; border:1px solid rgba(112,194,232,.2); border-radius:8px; background:rgba(14,55,76,.58); }.center-meta text,.center-meta b { display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.center-meta text { color:#7fa5b6; font-size:9px; }.center-meta b { margin-top:3px; color:#e6f8ff; font-size:11px; }
...
.stage-card { position:absolute; z-index:9; left:12px; bottom:12px; width:39%; min-width:200px; padding:11px 12px; box-sizing:border-box; border:1px solid rgba(114,207,237,.3); border-radius:10px; background:linear-gradient(145deg,rgba(5,38,55,.94),rgba(3,25,39,.9)); box-shadow:0 9px 28px rgba(0,10,18,.35); backdrop-filter:blur(7px); }.stage-card.video-mode { top:12px; bottom:auto; border-color:rgba(83,219,255,.58); box-shadow:0 9px 28px rgba(0,10,18,.4),inset 3px 0 #37d8f4; }.stage-card-head { display:flex; align-items:baseline; gap:8px; }.stage-card-head small { color:#5ce0ff; font:700 7px/1 ui-monospace,Consolas,monospace; letter-spacing:.8px; }.stage-card-head b { color:#fff; font-size:14px; }.stage-card > text { display:block; min-height:29px; margin-top:6px; color:#9fc2cf; font-size:8px; line-height:1.55; }.stage-progress { height:4px; margin-top:7px; overflow:hidden; border-radius:3px; background:rgba(105,176,202,.18); }.stage-progress i { display:block; height:100%; border-radius:3px; background:linear-gradient(90deg,#29bde7,#59eab1); box-shadow:0 0 10px rgba(50,212,255,.45); }.stage-card strong { display:block; margin-top:6px; color:#64e4ff; font:800 15px/1 ui-monospace,Consolas,monospace; }.video-status-card { position:absolute; z-index:9; right:12px; bottom:12%; width:34%; min-width:180px; padding:10px 12px; box-sizing:border-box; border:1px solid rgba(84,231,177,.52); border-radius:9px; color:#eafaff; background:linear-gradient(135deg,rgba(4,31,47,.98),rgba(5,51,66,.98)); box-shadow:0 8px 22px rgba(0,8,15,.42),inset 3px 0 #4ee5aa; backdrop-filter:blur(8px); }.video-status-card small,.video-status-card b,.video-status-card text { display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.video-status-card small { color:#71eab9; font-size:7px; }.video-status-card b { margin-top:4px; color:#fff; font-size:12px; }.video-status-card text { margin-top:4px; color:#9fc6d5; font-size:8px; }
.check-list { position:absolute; z-index:9; right:12px; bottom:12px; width:34%; padding:8px 9px; border:1px solid rgba(92,232,181,.28); border-radius:9px; background:rgba(3,34,43,.88); backdrop-filter:blur(6px); }.check-list.video-mode { bottom:12%; background:rgba(3,34,43,.96); }.check-list view { display:grid; grid-template-columns:11px 1fr auto; align-items:center; gap:6px; min-height:20px; color:#779eaa; font-size:7px; }.check-list i { width:7px; height:7px; border:1px solid #557e88; border-radius:50%; }.check-list b { color:#9cb8bf; font-weight:600; }.check-list view.done { color:#c7f8e5; }.check-list view.done i { border-color:#56e6ae; background:#43d89f; box-shadow:0 0 7px rgba(69,226,169,.5); }.check-list view.done b { color:#62e7b2; }
