...
.panel-title { font-size:14px }.panel-sub { font-size:9px }.decision-type { font-size:9px }
.decision-empty b { font-size:11px }.decision-empty text { font-size:8px }
.decision-meta text,.score-summary text { font-size:8px }.decision-meta b,.score-summary b { font-size:8px }
.section-title { font-size:10px }.candidate-name b { font-size:9px }.candidate-name small { font-size:7px }
.candidate-state,.candidate-facts text,.cost-row b { font-size:7px }.excluded-reason { font-size:8px }
.candidate-empty { font-size:9px }.selected-reason text { font-size:8px }.selected-reason b { font-size:9px }
</style>
