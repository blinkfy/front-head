...
.map-entity-sprite.robot .entity-ground-shadow { width:84%; height:12%; bottom:-1px; clip-path:polygon(0 54%,12% 22%,44% 8%,100% 38%,86% 77%,48% 96%,9% 78%); }
.map-entity-sprite.robot .entity-contact-shadow { width:58%; height:7%; }
.map-entity-sprite.bin .entity-ground-shadow { width:72%; height:12%; clip-path:polygon(0 42%,20% 12%,70% 8%,100% 46%,80% 88%,27% 91%,7% 69%); }
.map-entity-sprite.bin .entity-contact-shadow { width:48%; height:6%; }
