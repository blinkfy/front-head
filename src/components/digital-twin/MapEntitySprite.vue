...
.map-entity-sprite.robot .entity-ground-shadow { width:166%; height:32%; bottom:-10px; transform:translate(calc(-50% + var(--shadow-offset-x) + 18px),calc(var(--shadow-offset-y) - 2px)) rotate(24deg) skewX(-10deg); clip-path:none; border-radius:50% 42% 56% 44%; background:radial-gradient(ellipse at 22% 44%,rgba(0,12,20,.84) 0 10%,rgba(0,12,20,.54) 30%,rgba(0,12,20,.24) 53%,rgba(0,12,20,.07) 68%,transparent 84%),radial-gradient(ellipse at 58% 54%,rgba(0,12,20,.3) 0 16%,rgba(0,12,20,.1) 40%,transparent 68%); filter:blur(6.2px); opacity:1; }
.map-entity-sprite.robot .entity-contact-shadow { width:24%; height:4%; bottom:-2px; transform:translate(calc(-50% + 3px),0) skewX(-10deg); clip-path:polygon(13% 55%,34% 31%,72% 23%,95% 49%,78% 78%,36% 88%,9% 72%); background:radial-gradient(ellipse at 50% 50%,rgba(0,10,17,.18) 0 26%,rgba(0,10,17,.06) 60%,transparent 82%); filter:blur(1.7px); opacity:.22; }
.map-entity-sprite.bin .entity-ground-shadow { width:108%; height:20%; bottom:-6px; transform:translate(calc(-50% + var(--shadow-offset-x) + 8px),calc(var(--shadow-offset-y) - 1px)) rotate(21deg) skewX(-8deg); clip-path:none; border-radius:48% 38% 56% 42%; background:radial-gradient(ellipse at 24% 45%,rgba(0,12,20,.54) 0 12%,rgba(0,12,20,.31) 34%,rgba(0,12,20,.12) 58%,rgba(0,12,20,.04) 72%,transparent 86%),radial-gradient(ellipse at 58% 55%,rgba(0,12,20,.2) 0 17%,rgba(0,12,20,.07) 43%,transparent 70%); filter:blur(4.2px); opacity:.96; }
.map-entity-sprite.bin .entity-contact-shadow { width:30%; height:4%; bottom:-2px; transform:translate(calc(-50% + 2px),0) skewX(-8deg); clip-path:none; border-radius:48%; background:radial-gradient(ellipse at 50% 50%,rgba(0,10,17,.2) 0 28%,rgba(0,10,17,.06) 62%,transparent 82%); filter:blur(1.5px); opacity:.24; }
